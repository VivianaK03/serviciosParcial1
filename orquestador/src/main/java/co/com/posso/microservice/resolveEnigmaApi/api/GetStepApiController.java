...
import co.com.posso.microservice.resolveEnigmaApi.service.ServiceDos;
    ...
    public ResponseEntity<List<JsonApiBodyResponseSuccess>> getStep(@ApiParam(value = "request body get enigma step" ,required=true )  @Valid @RequestBody JsonApiBodyRequest body) {
       ...
       @GetMapping("/mensaje")
        public ResponseEntity<String> getMensaje(){
        	...
        	return new ResponseEntity<>(service.orquestador(), HttpStatus.OK);
    }
